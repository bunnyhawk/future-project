      ...
      <nav className="flex justify-between items-center flex-col sm:flex-row">
        <ul className="flex flex-col sm:flex-row order-2 sm:order-1 text-center">
          <li className="mb-1 sm:mr-4">
            <Link to="/" className="underline active:text-cta hover:text-cta focus:text-cta">Home</Link>
          </li>
          <li className="mb-1 sm:mr-4">
            <Link to="/about" className="underline active:text-cta hover:text-cta focus:text-cta">About</Link>
          </li>
          <li className="mb-1">
            <Link to="/donate" className="underline active:text-cta hover:text-cta focus:text-cta">Donate</Link>
          </li>
        </ul>
